/* 訪問者の集計(GoatCounter)。Cookie なし・個人の特定なし。
   ...
   計測スクリプトは assets/gc-count.js(公式の複製)。中国からも数えられるように自前で配っている。
...
(() => {
  ...
  s.async = true; s.src = new URL('gc-count.js', document.currentScript.src).href;   // gc.zgo.at は中国から届かないので、複製をこのサイトから配る
